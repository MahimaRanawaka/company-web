  ...
  sections: [
    ...
    },
    {
      ...
      filters: [
        ...
        "Quality Assurance",
        "Oolo Marketing Services",
      ],
      items: [
        {
          tag: "Oolo Marketing Services",
          title: "Anime Apparel Concept Design",
          body: "Three premium streetwear concepts built around iconic anime characters — extracting emotional identity through typography, composition, and print-conscious illustration.",
          metric: "Apparel Design",
          to: "/portfolio/anime-apparel-concepts",
          cover: "/portfolio/anime-apparel-concepts.webp",
        },
        {
          tag: "Oolo Marketing Services",
          title: "Brand Identity Design Collection",
          body: "Five distinct brand identities across fashion, technology, creative marketing, premium FMCG, and multi-business — each built around strategy, storytelling, and real-world scalability.",
          metric: "Brand Identity",
          to: "/portfolio/brand-identity-collection",
          cover: "/portfolio/brand-identity-collection.webp",
        },
        {
          tag: "Oolo Marketing Services",
          title: "Chiku — Brand Character Evolution",
          body: "A dual-state brand character bridging human creativity and AI intelligence — from graffiti-inspired Orange Chiku to the futuristic Blue Chiku, built for Oolo × Ennobler.",
          metric: "Brand Identity",
          to: "/portfolio/chiku-brand-character",
          cover: "/portfolio/chiku-brand-character.webp",
        },
        {
          tag: "Oolo Marketing Services",
          title: "Ceylon Raga Reserve — Premium Masala Brew Packaging",
          body: "Luxury packaging identity for a premium Sri Lankan masala tea brand — custom character design, hand-drawn botanical spice illustrations, and print-ready production.",
          metric: "Packaging Design",
          to: "/portfolio/ceylon-raga-reserve",
          cover: "/portfolio/ceylon-raga-reserve.webp",
        },
        {
          tag: "Oolo Marketing Services",
          title: "BOC WhatsApp Banking Campaign",
          body: "X Banner design and print production for Bank of Ceylon's WhatsApp Banking promotion — transforming a complex digital service into a clear, lifestyle-driven campaign visual.",
          metric: "Campaign Design",
          to: "/portfolio/boc-whatsapp-banking",
          cover: "/portfolio/boc-whatsapp-banking.webp",
        },
        {
          tag: "Oolo Marketing Services",
          title: "Raga Master — 3D Character Design",
          body: "A half-human, half-animal guardian character transformed from a single reference image into a complete 3D brand asset for the Ceylon Raga Reserve universe.",
          metric: "3D Character Design",
        ...
        },
        {
          ...
          body: "A layered AI production workflow combining character-driven storytelling, curiosity-driven hooks, and local cultural strategy to build brand-ready video campaigns.",
          metric: "AI Campaign",
          to: "/portfolio/ai-character-campaign",
          cover: "/portfolio/ai-character-campaign.webp",
        },
        {
          tag: "Oolo Marketing Services",
          title: "Ceylon Raga Reserve — Brand Identity & Cultural Campaign",
          body: "A complete brand universe — character storytelling, multilingual campaigns, and AI-assisted visuals that drove 101K views on day one from zero followers.",
          metric: "101K Views · Day 1",
        ...
        },
        {
          ...
          body: "A story-driven Halloween animation built around kindness and student connection — using Sora AI video generation to bring character-led storytelling to social media.",
          metric: "Animation · AI",
        ...
        {
          tag: "Oolo Marketing Services",
          title: "Logo Motion — Living Brand Experiences",
          body: "Two brands, two motion languages — WGM's premium cinematic logo reveal and Oolo's 3D playful universe, each communicating brand personality within seconds.",
          metric: "Motion Design",
          to: "/portfolio/logo-motion",
    ...
    },
    {
      ...
      items: [
        {
          title: "Problem",
          body: "The previous structure was unclear, hard to navigate, and did not explain the value quickly.",
        },
        {
          title: "Process",
          body: "We mapped user journeys, grouped content, planned wireframes, and validated the flow.",
        },
        {
          title: "Solution",
          body: "A clearer page structure with visual hierarchy, stronger CTA placement, and QA-backed delivery.",
        },
        {
          title: "Outcome",
          body: "Improved clarity, stronger trust, better project explanation, and smoother user decision-making.",
        },
      ],
    },
    {
      ...
      items: [
        {
          title: "Understand",
          body: "Identify the business goal, user problem, project scope, and delivery expectations.",
        },
        {
          title: "Design",
          body: "Create the structure, wireframe, content flow, visual direction, and interaction plan.",
        },
        {
          title: "Build",
          body: "Develop the software, website, QA workflow, automation layer, or marketing execution system.",
        },
        {
          title: "Test & Improve",
          body: "Validate usability, functionality, performance, content clarity, and release readiness.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      title:
        "Every project is reviewed for delivery quality and business impact.",
