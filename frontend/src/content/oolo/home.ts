...
export const ooloHome: PageContent = {
  ...
  sections: [
    ...
    // §7 ENGAGEMENT MODELS
    {
      ...
      subtitle: "Five engagement models. One growth team. Your call.",
      plans: [
        {
          badge: "Project",
          name: "Project-Based",
          tagline: "Fixed scope. Clear timeline. Delivered.",
          features: ["Fixed scope", "Clear timeline", "Defined delivery outcome"],
          cta: { label: "Go to Project Pricing →", to: "/oolo/pricing#project-based" },
        },
        {
          badge: "Retainer",
          ...
          cta: { label: "Go to Retainers →", to: "/oolo/pricing#retainer-model" },
          highlighted: true,
        ...
        },
        {
          badge: "Team Hiring",
          name: "Dedicated Team",
          tagline: "Dedicated creative and marketing talent inside your team.",
          features: ["Dedicated talent", "Flexible capacity", "Long-term collaboration"],
          cta: { label: "Go to Team Hiring →", to: "/oolo/pricing#team-hiring" },
        },
        {
          badge: "Performance",
          ...
          cta: { label: "Go to Outcomes →", to: "/oolo/pricing#performance-based" },
        },
        {
          badge: "Bundle",
          name: "Bundle Packages",
          tagline: "Build, brand, QA, and launch as one coordinated engagement.",
          features: ["One combined scope", "Single timeline", "Delivered with En'nobler"],
          cta: { label: "See Bundles →", to: "/oolo/pricing#bundles" },
        },
      ],
    },
