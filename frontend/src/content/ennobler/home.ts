...
export const ennoblerHome: PageContent = {
  ...
  sections: [
    // §3 HERO
    {
      ...
      image: { src: "/heroes/ennobler.webp", alt: "Byte, the En'nobler engineering mascot, holding a glowing intelligence orb amid software architecture panels" },
    },
    { type: "marquee", items: ["Built to Ship", "Engineered to Scale", "Zero Defect Mindset", "AI Powered", "Always Delivered"] },
    // hero stats band
    {
      type: "stats",
      items: [
    ...
    // §6 CORE SERVICES (the six thematic pillars from the wireframe)
    {
      ...
      bento: true,
      items: [
        { title: "AI-aided Engineering", summary: "AI-supported planning, development, review, testing, and technical decision-making for faster delivery.", to: "/ennobler/services/ai-automation", icon: "sparkles" },
        { title: "Quality Assurance", summary: "Manual testing, automation, regression checks, API testing, QA strategy, and release validation.", to: "/ennobler/services/quality-assurance", icon: "shield-check" },
        { title: "Software Development", summary: "Custom web systems, internal platforms, dashboards, portals, and scalable business applications.", to: "/ennobler/services/software-development", icon: "code" },
        { title: "Digital Transformation", summary: "Modernize workflows, replace manual processes, and create practical digital systems for business teams.", to: "/ennobler/services/digital-transformation", icon: "refresh-cw" },
        { title: "Web / App Development", summary: "Responsive websites, mobile-friendly interfaces, web apps, admin panels, and user portals.", to: "/ennobler/services/web-platform-development", icon: "monitor-smartphone" },
        { title: "Cloud / DevOps Support", summary: "Deployment, hosting support, CI/CD setup, infrastructure guidance, monitoring, and performance readiness.", to: "/ennobler/services/cloud-devops", icon: "cloud" },
        { title: "UI/UX Design", summary: "User research, wireframing, interface design, design systems, and usability testing for products people enjoy using.", to: "/ennobler/services/ui-ux-design", icon: "pen-tool" },
        { title: "Mobile App Development", summary: "Native and cross-platform mobile apps — from prototype to store launch — with performance and UX built in.", to: "/ennobler/services/mobile-app-development", icon: "smartphone" },
        { title: "API Development", summary: "REST and GraphQL APIs, third-party integrations, connectors, and secure, well-documented service layers.", to: "/ennobler/services/api-development", icon: "webhook" },
        { title: "E-Commerce Solutions", summary: "Online stores, checkout flows, payment integration, and scalable commerce platforms built to convert.", to: "/ennobler/services/ecommerce-solutions", icon: "shopping-cart" },
      ],
    },
    // §7 ENGAGEMENT MODELS
    {
      ...
      plans: [
        {
          ...
          features: ["Website / web app build", "System design", "QA & testing", "Launch support"],
        ...
        },
        {
          ...
          features: ["QA as a Service", "Continuous development", "Sprint-based delivery", "Maintenance & optimization"],
        ...
        },
        {
          ...
          features: ["Developer support", "QA specialist support", "DevOps support", "Product team extension"],
      ...
      items: [
        {
          ...
          cta: { label: "View E-commerce Product", to: "/ennobler/products/ecommerce-product" },
        },
        {
          ...
          cta: { label: "View Tourism Product", to: "/ennobler/products/tourism-product" },
        },
      ],
    },
    // §10 PROCESS
    {
      ...
      items: [
        ...
        { title: "Plan", body: "We define the solution structure, scope, and roadmap." },
    ...
    // §11 PORTFOLIO
    {
      ...
      subtitle: "A curated look across En'nobler's engineering and QA ecosystem.",
      filters: ["All Work", "QA as a Service", "Software Development", "Product Build", "Cloud / DevOps"],
      items: [
        { tag: "QA as a Service", title: "Platform Stabilization", body: "Cut production defects by 3x with a continuous QA layer across releases.", metric: "QA Result", to: "/portfolio" },
        { tag: "Software Development", title: "Business System Build", body: "Replaced manual workflows with a custom platform that scaled with the team.", metric: "Dev Result", to: "/portfolio" },
        { tag: "Cloud / DevOps", title: "Deployment Pipeline Setup", body: "CI/CD, monitoring, and performance readiness for confident, frequent shipping.", metric: "Cloud Result", to: "/portfolio" },
        { tag: "Product Build", title: "MVP to Market-Ready", body: "Product planning, build, testing, launch, and optimization end to end.", metric: "Product Result", to: "/portfolio" },
      ],
    },
