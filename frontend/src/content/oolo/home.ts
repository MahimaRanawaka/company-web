...
export const ooloHome: PageContent = {
  ...
  sections: [
    ...
    // §9 PORTFOLIO
    {
      ...
      filters: ["All Work", "Paid Media", "Brand Strategy", "Content", "SEO"],
      items: [
        { tag: "Paid Media", title: "E-commerce Revenue Surge", body: "Scaled a DTC brand from $50k to $400k monthly ad spend in 6 months while maintaining 4.8x ROAS.", metric: "4.8x ROAS", to: "/portfolio" },
        { tag: "SEO", title: "B2B Lead Generation Overhaul", body: "Rebuilt content architecture and authority strategy — tripled organic traffic and cut CPL by 55% in one year.", metric: "3x organic traffic", to: "/portfolio" },
        { tag: "Brand Strategy", title: "SaaS Rebrand & Repositioning", body: "Full brand overhaul for a Series A SaaS. New positioning, visual identity, and messaging lifted NPS by 42 points.", metric: "Brand NPS +42", to: "/portfolio" },
        { tag: "Content", title: "Content Production Engine", body: "Built a strategy-led creative production system delivering 10x volume without sacrificing brand voice or quality.", metric: "10x content output", to: "/portfolio" },
        { tag: "Paid Media", title: "GTM Blitz for Product Launch", body: "Coordinated paid, PR, and influencer push for a product launch — generated £2M pipeline in the first 90 days.", metric: "£2M pipeline in 90 days", to: "/portfolio" },
      ],
    },
