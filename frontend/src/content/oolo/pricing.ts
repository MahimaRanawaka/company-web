  ...
  sections: [
    ...
    // PROJECT-BASED
    {
      ...
      custom: {
        ...
        ctas: [{ label: "Request Custom Quote", to: "#enquiry-form" }],
      },
    ...
    // RETAINER — CUSTOM BAND
    {
      ...
      custom: {
        ...
        ctas: [{ label: "Build My Retainer", to: "#enquiry-form" }],
      },
      disclaimer: DISCLAIMER,
    },
    // TEAM HIRING
    {
      ...
      plans: [
        ...
        },
        {
          ...
          cta: { label: "Design My Team", to: "#enquiry-form" },
        },
      ],
    },
    ...
    // BUNDLES
    {
      ...
      custom: {
        ...
        ctas: [
          { label: "Request Bundle Proposal", to: "#enquiry-form" },
