...
export const portfolioContent: PageContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      items: [
{ tag: "Oolo Marketing Services", title: "Anime Apparel Concept Design", body: "Three premium streetwear concepts built around iconic anime characters — extracting emotional identity through typography, composition, and print-conscious illustration.", metric: "Apparel Design", to: "/portfolio/anime-apparel-concepts", cover: "/portfolio/anime-apparel-concepts.webp" },
        ...
        { tag: "Oolo Marketing Services", title: "Chiku — Brand Character Evolution", body: "A dual-state brand character bridging human creativity and AI intelligence — from graffiti-inspired Orange Chiku to the futuristic Blue Chiku, built for Oolo × Ennobler.", metric: "Brand Identity", to: "/portfolio/chiku-brand-character", cover: "/portfolio/chiku-brand-character.webp" },
        ...
        { tag: "Oolo Marketing Services", title: "Raga Master — 3D Character Design", body: "A half-human, half-animal guardian character transformed from a single reference image into a complete 3D brand asset for the Ceylon Raga Reserve universe.", metric: "3D Character Design", to: "/portfolio/raga-master-character", cover: "/portfolio/raga-master-character.webp" },
