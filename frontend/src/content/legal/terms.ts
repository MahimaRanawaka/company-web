...
export const termsDoc: LegalDoc = {
  ...
  sections: [
    ...
    {
      id: "services",
      heading: "3. Our services and engagements",
      paragraphs: [
    ...
    {
      id: "accounts",
      heading: "4. Communications and accounts",
      paragraphs: [
    ...
    },
    {
      ...
      paragraphs: ["When using our website and services, you agree not to:"],
      bullets: [
    ...
    {
      id: "deliverables-ownership",
      heading: "7. Ownership of deliverables",
      paragraphs: [
