...
const DATA: EnService[] = [
  {
    ...
    deliverablesLayout: "split",
    deliverables: [
      { title: "Source Code Repository", body: "Full codebase with commit history, branching strategy, and README documentation.", icon: "folder-git-2" },
      { title: "Architecture Diagram", body: "System design doc covering all components, integrations, and data flows.", icon: "network" },
      { title: "API Documentation", body: "Complete API reference — endpoints, payloads, auth, and error handling.", icon: "book-open" },
      { title: "Test Suite", body: "Unit, integration, and end-to-end test coverage for all core functionality.", icon: "flask-conical" },
      { title: "Deployment Pipeline", body: "CI/CD configuration for staging and production environments.", icon: "git-branch" },
      { title: "Maintenance Handover", body: "Runbook, environment setup guide, and 30-day post-launch support.", icon: "life-buoy" },
    ],
  ...
  },
  {
    ...
    deliverablesLayout: "split",
    deliverables: [
      { title: "Production Web App", body: "Fully deployed, optimised web platform on your domain.", icon: "rocket" },
      { title: "CMS Configuration", body: "Content model, editorial workflow, and training guide for your team.", icon: "layout-template" },
      { title: "SEO Baseline Report", body: "Initial rankings snapshot plus on-page SEO audit.", icon: "search" },
      { title: "Performance Report", body: "Lighthouse scores and Core Web Vitals baseline.", icon: "gauge" },
      { title: "Component Library", body: "Documented UI component library for future development.", icon: "component" },
      { title: "Analytics Dashboard", body: "Configured tracking with key conversion events.", icon: "line-chart" },
    ],
  ...
  },
  {
    ...
    deliverablesLayout: "split",
    deliverables: [
      { title: "App Store & Play Store Listing", body: "Published app with optimised screenshots, descriptions, and metadata.", icon: "store" },
      { title: "Source Code", body: "Full codebase with CI/CD pipeline for ongoing builds.", icon: "folder-git-2" },
      { title: "Backend API", body: "Documented REST or GraphQL API powering the app.", icon: "webhook" },
      { title: "Analytics Setup", body: "Event tracking, funnels, and crash reporting configured.", icon: "bug" },
      { title: "Test Coverage Report", body: "Unit and integration test results with device matrix.", icon: "flask-conical" },
      { title: "Release Runbook", body: "Step-by-step guide for future releases and hotfixes.", icon: "book-open" },
    ],
  ...
  },
  {
    ...
    deliverablesLayout: "split",
    deliverables: [
      { title: "Research Report", body: "User interview synthesis, personas, and key insight summary.", icon: "users" },
      { title: "User Flow Diagrams", body: "End-to-end task flows for all primary user journeys.", icon: "network" },
      { title: "Wireframe Deck", body: "Full low-fidelity layout for every screen.", icon: "layout-grid" },
      { title: "High-Fidelity Designs", body: "Production-ready Figma files with all states and variants.", icon: "palette" },
      { title: "Clickable Prototype", body: "Shareable prototype for stakeholder review and usability testing.", icon: "mouse-pointer-click" },
      { title: "Design System", body: "Component library with documented colour, type, spacing, and icon tokens.", icon: "component" },
    ],
  ...
  },
  {
    ...
    deliverablesLayout: "split",
    deliverables: [
      { title: "Infrastructure as Code", body: "Terraform/Pulumi codebase for all provisioned resources.", icon: "file-code" },
      { title: "CI/CD Pipeline", body: "Fully automated build, test, and deploy workflow.", icon: "git-branch" },
      { title: "Architecture Diagram", body: "Current-state and target-state infra diagrams.", icon: "network" },
      { title: "Runbook", body: "Incident response, rollback procedures, and scaling playbooks.", icon: "book-open" },
      { title: "Monitoring Dashboard", body: "Live dashboards covering latency, error rates, and cost.", icon: "activity" },
      { title: "Security Baseline Report", body: "IAM audit, secrets management review, and CVE scan results.", icon: "shield-check" },
    ],
  ...
  },
  {
    ...
    deliverablesLayout: "split",
    deliverables: [
      { title: "OpenAPI Specification", body: "Machine-readable API spec for all endpoints, payloads, and auth flows.", icon: "file-code" },
      { title: "Developer Documentation", body: "Hosted docs with examples, error codes, and quick-start guide.", icon: "book-open" },
      { title: "Postman Collection", body: "Ready-to-run collection for every endpoint.", icon: "folder" },
      { title: "Test Suite", body: "Automated contract, integration, and load tests.", icon: "flask-conical" },
      { title: "Monitoring Setup", body: "Uptime and latency monitoring with alerting.", icon: "activity" },
      { title: "Integration Guide", body: "Step-by-step guide for each third-party connection.", icon: "puzzle" },
    ],
  ...
  },
  {
    ...
    deliverablesLayout: "split",
    deliverables: [
      { title: "Automation Workflow", body: "End-to-end automated process with logging, error handling, and audit trail.", icon: "workflow" },
      { title: "AI Integration", body: "LLM-powered feature embedded in your product or internal tool.", icon: "sparkles" },
      { title: "ML Model + API", body: "Trained model served as an API with versioning and rollback.", icon: "cpu" },
      { title: "Evaluation Report", body: "Accuracy benchmarks, failure analysis, and improvement roadmap.", icon: "clipboard-check" },
      { title: "Monitoring Dashboard", body: "Live metrics on automation performance and model drift.", icon: "activity" },
      { title: "Retraining Playbook", body: "Guide for updating models as your data evolves.", icon: "book-open" },
    ],
  ...
  },
  {
    ...
    deliverablesLayout: "split",
    deliverables: [
      { title: "Test Plan", body: "Scope, strategy, resource allocation, and exit criteria.", icon: "clipboard-list" },
      { title: "Test Case Library", body: "Full suite of manual and automated test cases in TestRail or equivalent.", icon: "flask-conical" },
      { title: "Automation Suite", body: "CI-integrated automated test scripts with coverage report.", icon: "bot" },
      { title: "Defect Reports", body: "Logged, prioritised, and tracked defect list with root cause analysis.", icon: "bug" },
      { title: "Performance Report", body: "Load test results with bottleneck identification and recommendations.", icon: "gauge" },
      { title: "Test Summary Report", body: "Release sign-off document with pass/fail rates and residual risk.", icon: "clipboard-check" },
    ],
  ...
  },
  {
    ...
    deliverablesLayout: "split",
    deliverables: [
      { title: "Production Storefront", body: "Fully deployed, branded e-commerce site with all pages and flows.", icon: "store" },
      { title: "Payment Integration", body: "Tested payment flow with sandbox and production credentials.", icon: "credit-card" },
      { title: "Admin Dashboard", body: "Order, inventory, and customer management interface.", icon: "layout-dashboard" },
      { title: "Search & Filter", body: "Faceted product search with category, price, and attribute filters.", icon: "search" },
      { title: "Analytics Setup", body: "Purchase funnel tracking, revenue events, and abandoned cart monitoring.", icon: "line-chart" },
      { title: "Launch Checklist", body: "Performance audit, security review, and load test results.", icon: "clipboard-check" },
    ],
  ...
  },
  {
    ...
    deliverablesLayout: "split",
    deliverables: [
      { title: "Technology Audit Report", body: "Current-state analysis with findings, risks, and quick wins.", icon: "clipboard-check" },
      { title: "Transformation Roadmap", body: "12–24 month initiative plan with owners, timelines, and success metrics.", icon: "map" },
      { title: "Architecture Decision Records", body: "Documented rationale for major technical decisions.", icon: "file-text" },
      { title: "Vendor Evaluation Matrix", body: "Scored comparison of shortlisted platforms or tools.", icon: "handshake" },
      { title: "Team Capability Assessment", body: "Skills gap analysis and hiring/training recommendations.", icon: "users" },
      { title: "Executive Summary Deck", body: "Board-ready presentation of findings and recommended direction.", icon: "presentation" },
    ],
