...
export const ENNOBLER: BrandConfig = {
  id: "ennobler",
  name: "En'nobler",
  logo: { src: "/logo/ennobler.webp", alt: "En'nobler" },
  base: "/ennobler",
...
export const OOLO: BrandConfig = {
  id: "oolo",
  name: "Oolo",
  logo: { src: "/logo/oolo.webp", alt: "Oolo" },
  base: "/oolo",
  ...
  email: "hello@en-nobler.com",
  copyright:
    "© 2026 En'nobler (Private) Limited. Oolo is a brand of En'nobler (Private) Limited.",
};
...
export function brandFromPath(pathname: string): Brand | null {
  if (pathname === "/ennobler" || pathname.startsWith("/ennobler/"))
    return "ennobler";
