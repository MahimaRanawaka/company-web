  ...
  sections: [
    {
      ...
      image: {
        src: "/heroes/pricing-oolo.webp",
        alt: "Oolo pricing — project-based, monthly retainer, dedicated team, and performance-based engagement models",
      },
      imageUnframed: true,
      imageAspect: "1744/1915",
      imageMaxWidth: "380px",
    ...
    // MODELS OVERVIEW
    {
      ...
      plans: [
        ...
        },
        {
          ...
          tagline:
            "Best for brands that need continuous content, campaigns, platform management, and ongoing growth support.",
          features: [
            "Monthly execution",
            "Consistent output",
        ...
        },
        {
          ...
          name: "Dedicated Team",
          tagline:
            "Best for businesses that need ongoing access to creative, multimedia, marketing, and strategic specialists.",
          features: [
            "Dedicated talent",
            "Flexible capacity",
        ...
        },
        {
          ...
          tagline:
            "Best when the build, QA, branding, and launch campaign should run as one coordinated engagement.",
          features: [
            "One combined scope",
            "Single timeline",
            "Delivered with En'nobler",
          ],
    ...
    // PROJECT-BASED
    {
      ...
      subtitle:
        "Choose a clearly defined creative or marketing service with an estimated starting price and a direct next step.",
      columns: ["Service", "Starting Price", "What's Included"],
      rows: [
        {
          name: "Logo Design",
          price: "$300–$800",
          body: "Logo concepts, selected variations, and a basic brand guide.",
        },
        {
      ...
      plans: [
        {
          ...
          price: "$1,200 / month",
          tagline:
            "Consistent foundational content and platform support for growing brands.",
          features: [
            "8 short-form videos",
        ...
        },
        {
          ...
          price: "$2,500 / month",
          tagline:
            "Higher content volume, campaign execution, and structured growth support.",
          features: [
        ...
        },
        {
          ...
          price: "$5,000 / month",
          tagline:
            "Full-scale content, paid media, optimisation, and reporting support for ambitious growth.",
          features: [
            "20+ videos or reels",
    ...
    // RETAINER — CUSTOM BAND
    {
      ...
      custom: {
        ...
        features: [
          "Output volume set to your calendar",
          "Choose your platforms and formats",
          "Reviewed and rebalanced each quarter",
        ],
        ctas: [
          {
    ...
    // TEAM HIRING
    {
      ...
      eyebrow: "Team Hiring",
      title:
        "Dedicated creative and marketing talent for long-term support needs.",
      subtitle:
      ...
      plans: [
        {
          ...
          tagline:
            "Ongoing brand and content support for businesses that need consistent creative output.",
          features: [
            "Graphic Designer",
            "Content Creator",
            "Copywriting support",
        ...
        },
        {
          ...
          tagline:
            "A focused multimedia team for short-form video, motion design, and AI-aided visual production.",
          features: [
            "Video Editor",
            "Motion Designer",
            "Graphic Designer",
            "Short-form video production",
            "AI-aided visual production",
          ],
          cta: { label: "Talk to Sales", to: "/contact" },
          highlighted: true,
          popular: "Recommended",
        },
        {
          ...
          tagline:
            "Embedded marketing capacity for planning, campaign support, content execution, and monthly optimisation.",
          features: [
        ...
        },
        {
          ...
          tagline:
            "End-to-end creative and marketing support for brands that need a dedicated long-term growth function.",
          features: [
        ...
        },
        {
          ...
          features: [
            ...
            "Scale up or down between campaigns",
          ],
          cta: {
            label: "Design My Team",
            to: "#enquiry-form",
    ...
    // PERFORMANCE-BASED
    {
      ...
      title:
        "Performance-based marketing aligned with agreed business outcomes.",
      subtitle:
      ...
      plans: [
        {
          ...
          tagline:
            "For selected campaigns with measurable goals and clearly defined attribution.",
          features: [
        ...
        },
        {
          ...
          tagline:
            "For brands seeking measurable improvement from consistent content and campaign execution.",
          features: [
            "Reach and engagement improvement",
        ...
        },
        {
          ...
          tagline:
            "For longer-term growth engagements with an agreed baseline, attribution method, and review process.",
          features: [
            "Funnel conversion",
            "Return on ad spend",
            "Customer acquisition efficiency",
            "Revenue contribution",
            "Campaign growth targets",
          ],
    ...
    // PERFORMANCE-BASED ENQUIRY
    {
      ...
      planOptions: [
        ...
        "Content Growth Plan",
        "Growth Optimisation Partnership",
      ...
      infoItems: [
        ...
        {
          title: "The attribution model",
          body: "Which platform, tool, or report decides whether a result counts.",
        },
        {
    ...
    // BUNDLES
    {
      ...
      custom: {
        title:
          "Want the build, the brand, and the launch handled as one package?",
    ...
    // FAQ
    {
      ...
      subtitle:
        "Clear answers about project pricing, retainers, teams, AI-aided creative work, and performance-based engagements.",
      items: [
        {
    ...
    },
    {
      ...
      formNote:
        "Sending this does not commit you to anything. You will receive a written proposal with fixed scope, revision rounds, and price before any work or payment.",
      infoEyebrow: "What happens next",
      infoTitle: "No obligation, no pressure.",
      infoItems: [
        {
          title: "Within 1 business day",
          body: "We reply and ask any clarifying questions about scope and timeline.",
        },
        {
          title: "A 30-minute call",
          body: "We walk through the brief, the channels, and what success looks like.",
        },
        {
          title: "A written proposal",
          body: "Fixed scope, deliverables, revision rounds, timeline, and price.",
        },
      ],
      infoNote: {
        label: "Prefer email?",
