  ...
  sections: [
    {
      ...
      image: {
        src: "/heroes/pricing-ennobler.webp",
        alt: "En'nobler pricing — project-based, retainer, team hiring, and performance-based engagement models",
      },
      imageUnframed: true,
      imageAspect: "1744/2019",
      imageMaxWidth: "380px",
      gridColumns: "lg:grid-cols-[1.15fr_0.85fr]",
    },
    {
      type: "stats",
      items: [
      ...
      plans: [
        {
          ...
          name: "Project-Based",
          tagline:
            "Best for clearly defined websites, MVPs, portals, integrations, QA audits, and one-time technical initiatives.",
          features: [],
        ...
        },
        {
          ...
          name: "Retainer Model",
          tagline:
            "Best for ongoing support, monthly QA, maintenance, technical improvements, and a predictable delivery rhythm.",
          features: [],
        ...
        },
        {
          ...
          name: "Team Hiring",
          tagline:
            "Best when you need dedicated delivery capacity like a Developer + QA pair, a product pod, or an AI product team.",
          features: [],
        ...
        },
        {
          ...
          tagline:
            "Best for selected QA or automation engagements with measurable outcomes such as test coverage or defect reduction.",
          features: [],
        ...
        },
        {
          ...
          tagline:
            "Best when product build, QA, branding, and the launch campaign should run as one coordinated engagement.",
          features: [],
    ...
    // PROJECT-BASED
    {
      ...
      custom: {
        ...
        features: [
          "Any mix of web, product, API, and QA work",
          "Single scope document and timeline",
          "Fixed proposal before work starts",
        ],
        ctas: [
          {
      ...
      plans: [
        {
          ...
          price: "$500 / month",
          tagline:
            "For ongoing website updates, maintenance, bug fixes, and small improvements.",
          features: [
        ...
        },
        {
          ...
          price: "$1,000 / month",
          tagline:
            "For companies that need software improvement and technical support every month.",
          features: [
        ...
        },
        {
          ...
          price: "$2,000 / month",
          tagline:
            "For SaaS, APIs, AI systems, and release teams that need structured QA month after month.",
          features: [
            "Regression testing",
            "API testing",
    ...
    },
    {
      ...
      custom: {
        ...
        features: [
          "Hours and coverage set to your load",
          "Mix support, QA, and improvement work",
          "Reviewed and adjusted each quarter",
        ],
        ctas: [
          {
            label: "Build My Retainer",
            to: "#contact",
    ...
    // TEAM HIRING
    {
      ...
      plans: [
        ...
        },
        {
          ...
          tagline:
            "Practical cross-functional delivery for growing product teams.",
          features: [
            "1 Developer",
            "1 QA Engineer",
            "Weekly planning",
        ...
        },
        {
          ...
          price: "Custom monthly pricing",
          tagline:
            "For AI-assisted product or automation-focused delivery needs.",
          features: [
            "AI Engineer",
            "Software Developer",
            "QA Engineer",
    ...
    },
    {
      ...
      custom: {
        ...
        features: [
          "Choose roles, seniority, and team size",
          "Part-time or full-time allocation",
          "Scale up or down between phases",
        ],
        ctas: [
          { label: "Design My Team", to: "#contact", model: "Team Hiring" },
        ],
      },
      disclaimer: DISCLAIMER,
    },
    // PERFORMANCE-BASED
    {
      ...
      subtitle:
        "For selected QA and automation engagements where commercial terms can be linked to agreed measurable outcomes.",
      tightBottom: true,
      plans: [
        {
          badge: "Quality",
    ...
    // PERFORMANCE-BASED ENQUIRY
    {
      ...
      infoItems: [
        ...
        {
          title: "The measurement method",
          body: "Which test suite, tool, or report decides whether a result counts.",
        },
        {
        ...
        {
          title: "The review period",
          body: "How often results are reviewed and when the commercial component is settled.",
        },
      ],
      infoNote: {
    ...
    // DECISION GUIDE
    {
      ...
      subtitle:
        "A quick guide to which pricing model matches your requirement.",
      columns: 3,
      items: [
        {
          title: "One-time website, app, MVP, or platform",
          body: "→ Project-Based",
          to: "#project",
        },
        {
          title: "Continuous website, product, or technical support",
          body: "→ Retainer Model",
          to: "#retainer",
        },
        {
          title: "Monthly QA support or regression testing",
          body: "→ QaaS Retainer",
          to: "#retainer",
        },
        {
          title: "Extra developers, QA engineers, or specialists",
          body: "→ Team Hiring",
          to: "#team",
        },
        {
          title: "Selected QA goals with measurable outcomes",
          body: "→ Performance-Based",
          to: "#performance",
        },
        {
          title: "Build, QA, branding, and launch together",
          body: "→ Bundle Packages",
          to: "#bundles",
        },
      ],
      footer: {
    ...
    // PROCESS
    {
      ...
      items: [
        {
          title: "Understand",
          body: "We clarify your business goal, technical need, timeline, and expected outcome.",
        },
        {
          title: "Recommend Model",
          body: "We suggest project-based, retainer, team hiring, or performance-based pricing.",
        },
        {
          title: "Define Scope",
          body: "We confirm deliverables, responsibilities, support level, and measurable success metrics.",
        },
        {
          title: "Confirm Capacity",
          body: "We agree on timeline, team involvement, communication rhythm, and delivery checkpoints.",
        },
        {
          title: "Start Delivery",
          body: "Work begins with transparent tracking, progress updates, and first review milestones.",
        },
      ],
    },
    // FAQ
    ...
    },
    {
      ...
      requirementPlaceholder:
        "Describe your product, current stage, and what you want to achieve.",
      formNote:
        "Sending this does not commit you to anything. You will receive a written proposal with fixed scope and price before any work or payment.",
      infoEyebrow: "What happens next",
      infoTitle: "No obligation, no pressure",
      infoItems: [
        {
          title: "Within 1 business day",
          body: "We reply and ask any clarifying questions.",
        },
        {
          title: "A 30-minute call",
          body: "We walk through scope, constraints, and timeline.",
        },
        {
          title: "A written proposal",
          body: "Fixed scope, price, timeline, and QA depth.",
        },
      ],
      infoNote: {
        label: "Prefer email?",
