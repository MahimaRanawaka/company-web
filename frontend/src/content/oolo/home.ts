    ...
    // §7 ENGAGEMENT MODELS
    {
      ...
      plans: [
        ...
        },
        {
          ...
          cta: {
            label: "Go to Retainers →",
            to: "/oolo/pricing#retainer-model",
          },
          highlighted: true,
        ...
        },
        {
          ...
          cta: {
            label: "Go to Team Hiring →",
            to: "/oolo/pricing#team-hiring",
          },
        },
        {
          badge: "Performance",
          ...
          cta: {
            ...
            to: "/oolo/pricing#performance-based",
          },
        },
        {
          badge: "Bundle",
          ...
          tagline:
            "Build, brand, QA, and launch as one coordinated engagement.",
          features: [
            "One combined scope",
            "Single timeline",
