  ...
  sections: [
    ...
    // PROJECT-BASED
    {
      ...
      custom: {
        ...
        ctas: [{ label: "Request Custom Quote", to: "#contact", model: "Project-Based" }],
      },
    ...
    },
    {
      ...
      custom: {
        ...
        ctas: [{ label: "Build My Retainer", to: "#contact", model: "Retainer Model" }],
      },
      disclaimer: DISCLAIMER,
    },
    // TEAM HIRING
    ...
    },
    {
      ...
      custom: {
        ...
        ctas: [{ label: "Design My Team", to: "#contact", model: "Team Hiring" }],
      },
      disclaimer: DISCLAIMER,
    },
    // PERFORMANCE-BASED
    ...
    // BUNDLES
    {
      ...
      custom: {
        ...
        ctas: [
          { label: "Request Bundle Proposal", to: "#contact", model: "Bundle Package" },
